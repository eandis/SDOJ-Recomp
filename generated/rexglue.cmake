...
# Codegen target - run 'cmake --build . --target saidaioujou_recomp_tu1_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(saidaioujou_recomp_tu1_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/saidaioujou_recomp_tu1_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for saidaioujou_recomp_tu1"
    VERBATIM
)
